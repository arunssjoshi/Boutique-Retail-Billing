                    ...
                    <div class="tab-content">
                        <div id="tab_1-1" class="tab-pane active">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" tabindex="1" placeholder="Property" id="property" name="property" class="form-control">
                            </div>
                        ...
                        <div id="tab_1-1" class="tab-pane active">
                            ...
                            <div class="form-group">
                                <div class="box-footer">
                                    <button id="btnPropertySave" class="btn btn-primary  pull-right" type="submit">Save</button><br/>
                                </div>
                            </div>
                        </div><!-- /.tab-pane -->
                    </div><!-- /.tab-content -->
...
<div id="optionHtml" class="hide">
    <div class="optionRow">
        <div class="row">
            <div class="col-xs-4">
                <input type="text" placeholder="Option" tabindex="2" name="option[]" class="form-control txtPropertyOption">
            </div>
            <div class="col-xs-2">
