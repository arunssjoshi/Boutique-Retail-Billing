        ...
        <div class="box-body table-responsive">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" id="category" name="category" tabindex="0"   class="form-control">
                </div>
                <label id="lbl-category" class="error softHide" style="" for="category"></label>
                <br/>
                <div class="input-group">
                    <span class="input-group-addon">Description&nbsp;&nbsp;&nbsp;</span>
                    <textarea id="description" tabindex="1"  name="description" class="form-control"></textarea>
                </div>
                <br/>
                <div class="input-group">
                    <span class="input-group-addon">Tax (%)</span>
                    <input type="text" id="tax" name="tax" tabindex="2" value="0"   class="form-control">
                </div>
                <br/>
                <div class="input-group">
                    <span class="input-group-addon">Unit&nbsp;&nbsp;&nbsp;</span>
                    <select id="ddUnit" name="ddUnit"    class="form-control"  tabindex="3" >
